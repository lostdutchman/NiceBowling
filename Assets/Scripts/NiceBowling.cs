...
public class NiceBowling : MonoBehaviour {
    ...
    public List<string> Effect(int niceRandom) {
        ...
        {
            int TempNum = UnityEngine.Random.Range(4, 7); //Note that max is exclusive, so using Random.Range( 0, 10 ) will return values between 0 and 9. If max equals min, min will be returned
