...
public class NiceBowling : MonoBehaviour {
    ...
    public void NiceManager()
    {
        ...
        //switch (i)
        //{
        //    case 1: Effects.Add(SpikeBall()); Effects.Add(MinigolfWindmill()); break;
        //    case 2: Effects.Add(SpikeBall()); Effects.Add(Pendulums()); break;
        //    case 3: Effects.Add(SpikeBall()); Effects.Add(Obsticals()); break;
        //    case 4: Effects.Add(SpikeBall()); Effects.Add(AddPinsx6()); break;
        //    case 5: Effects.Add(SpikeBall()); Effects.Add(LandMine()); break;
        //    case 6: Effects.Add(SpikeBall()); Effects.Add(RampAdd()); break;
        //    case 7: Effects.Add(SpikeBall()); Effects.Add(MinigolfWindmill()); break;
        //    case 8: Effects.Add(SpikeBall()); Effects.Add(CubeWall()); break;
        //    case 9: Effects.Add(SpikeBall()); Effects.Add(SardineRain()); break;
        //    case 10: Effects.Add(SpikeBall()); Effects.Add(Bumpers()); break;
